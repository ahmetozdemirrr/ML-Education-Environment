/* ./frontend/src/App.js - Enhanced with Dark Mode */
...
function App()
{
  ...
  return (
    ...
    <div className="panel simulation-panel" ref={simulationPanelRef}>
      ...
      {/* DARK MODE BUTTON - YENİ POZİSYON */}
      <div className="dark-mode-toggle-fixed">
        <button
          onClick={toggleDarkMode}
          className="dark-mode-btn-fixed"
